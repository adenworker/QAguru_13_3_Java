...
public class Main {
    ...
    public static void arrays() {
        ...
        int[] arrayExample = new int[] {66, 22, 1, 98, 3554};
    ...
    public static void primitiveDataTypesInteraction() {
        ...
        System.out.println("This is an example of addition in Java: 5 plus 3 equals " + additionExample);
        ...
        System.out.println("This is an example of multiplication in Java: 5 times 3 equals " + multiplicationExample);
        ...
        System.out.println("This is an example of modulus division in Java: 15 divided by 2 equals " + modDivisionExample);
    ...
    public static void overflow() {
        ...
        System.out.println("This is an example of overflow minimum value of type in Java: int -1000000000 minus int " +
                "2000000000 equals " + overflowMaxResult);
